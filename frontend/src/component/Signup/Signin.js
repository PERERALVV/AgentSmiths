        ...
        <div className='loginPage'>
            <Grid container className={classes.gridContainer}>
                <Grid item xs={12} lg={6}>
                    <Hidden mdDown>
                        <img src="./img/Login.gif" alt="Image" className={classes.loginImage} />
                    </Hidden>
                </Grid>
                <Grid item xs={12} lg={6} className={classes.rightcon} sx={{ paddingLeft:"12%" }}>
                        ...
                        <Stack className={classes.formContainer} direction="column" spacing={0}>
                            <form onSubmit={handleSubmit}>
                                <Stack direction="column">
                                    ...
                                    />
                                    <Button sx={{ borderRadius: '20px', marginTop: passwordError ? '1rem' : '0' }} className={classes.signButton} variant="contained" color='primary' type="submit">Sign up</Button>
                                </Stack>
                            </form>
