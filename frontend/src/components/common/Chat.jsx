...
function Chat() {
    ...
    const handleEndConversation = () => {
      ...
      setMessages((prevMessages) => [
        ...prevMessages,
        {
          sid: sid,
          message:
            "Yayy! Now I have all the information to create the perfect website for you! Your website is now being built.",
          type: "chat_response",
        },
      ]);
    ...
    const handleSomethingWrong = () => {
      setMessages((prevMessages) => [
        ...prevMessages,
        {
          sid: sid,
          message:
            "Oops! Something went wrong. You will be directed to the Home page",
          type: "warning",
        },
      ]);
  ...
  const handleMessageSend = () => {
    if (message.trim()) {
      setMessages((prevMessages) => [
        ...prevMessages,
        { sid: sid, message: message.trim(), type: "chat" },
      ]);
  ...
  const handleHelpAnswer = () => {
    ...
    const lastChatResponse = [...messages]
      .reverse()
      .find((msg) => msg.type === "chat_response");
    ...
    const newWarningTimer = setTimeout(() => {
      setMessages((prevMessages) => [
        ...prevMessages,
        {
          sid: sid,
          message:
            "You have not responded for 120 seconds. Please respond to avoid conversation termination",
          type: "warning",
        },
      ]);
  ...
  return (
    <ChatDiv>
      ...
      <ClarifyButton onClick={handleHelpAnswer} disabled={isInputDisabled}>
        Help me answer
      </ClarifyButton>
    </ChatDiv>
  );
