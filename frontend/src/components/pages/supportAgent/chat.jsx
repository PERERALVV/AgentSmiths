import { MessageList, Message,TypingIndicator,MessageSeparator } from '@chatscope/chat-ui-kit-react';
...
return (
    <Container>
        ...
        <MessageList
            ...
            scrollBehavior="auto"
            typingIndicator={isTyping ? <TypingIndicator content="waiting for user reply...." /> : null}
        >
                ...
                i === chatlength-1 ? (
                  <>
                    <Message 
                      ...
                      style={{}}
                    />
                  <MessageSeparator as="h1" content="chat with human starts from here" />
                  </>
                ) : (<>
                  <Message 
                  key={i} 
