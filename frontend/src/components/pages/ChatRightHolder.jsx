...
import { DownloadButton, RightHolderDiv, RightHolderImage } from '../../styles/pages/ChatInterface';
...
function ChatRightHolder() {
  ...
  return (
    <RightHolderDiv>
      ...
      {isCodeReady ? (
        <DownloadButton onClick={handleDownload}>Download Source Code</DownloadButton> // Render the download button when code is ready
      ) : (
        <GradientTextDiv>
          Building ...
        </GradientTextDiv>
