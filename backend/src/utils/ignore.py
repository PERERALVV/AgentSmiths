...
import importlib
IGNORE_PATHS=getattr(importlib.import_module('const.common'), 'IGNORE_PATHS')
IGNORE_SIZE_THRESHOLD=getattr(importlib.import_module('const.common'), 'IGNORE_SIZE_THRESHOLD')
