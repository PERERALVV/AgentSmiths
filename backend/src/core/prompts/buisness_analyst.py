...
The AI developer prefers working on web apps using JAVASCRIPT/REACT stack, and use REACT with Styled components on the frontend, unless the client has different requirements.
...
-----------output-format-----------------------------
{
    "state":"<Question or Specification>",
    "content":"<Content of the question or specification>"
}
-----------end-of-outputformat-----------------------
YOUR RESPONSE:
"""
...
-----------output-format-----------------------------
{
    "type":"<MISSING-INFORMATION or APPROVE>",
    "content":"<the information that is missing>"
}
-----------end-of-outputformat-----------------------
YOUR RESPONSE:"""

SPEC_RECORRECT="""YOUR SPECIFICATION IS MISSING THE FOLLOWING INFORMATION
---------------------------------------------------------------
{{ missinginfo }}
---------------------------------------------------------------
