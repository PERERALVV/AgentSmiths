...
def get_project_data(project):
    ...
    project_data = {"project_name": project_name, "project_description": project_description,
                    "no_of_webpages": no_of_webpages, "webpage_names": webpage_names, "webpage_descriptions": webpage_descriptions}
